...
const IndexPage = () => (
  <Layout>
    ...
    <div className="container mt-16">
      ...
      <p className="mt-4">Just as the flora and fauna of the Great Plains are shaped by the rolling prairies and rugged climate in which they exist, non-profits face special challenges and unique opportunities based on their geographic, cultural, and political environments. At Coneflower Consulting, we are committed to helping creative non-profits in the Midwest flourish. Whether your non-profit organization’s mission is in arts & culture, humanities, or education, we’re here to help you cultivate the resources you need to thrive.</p>
      <p className="mt-4">The humble coneflower is a common sighting amongst the prairie grasses of the Great Plains. Deceptively delicate-looking with its petals ranging in hue from dark magenta to light pink, the coneflower is actually a drought-tolerant perennial that uses its long taproot and affinity for sunlight to persevere and prosper across the Midwest.</p>
      <p className="mt-4">Coneflower Consulting was founded by Sarah Bishop, a longtime Kansan with a commitment to maintaining and expanding the vibrant creative, cultural, and educational community of the Midwest. With her PhD in literature and media from the University of Virginia. and over a decade of experience in grant writing, fundraising, communications, strategic planning, and leadership for Midwest non-profits and institutions of higher education, Sarah is excited to help your Midwestern non-profit build on its past successes to reach new heights.</p>
    </div>
  </Layout>
)
